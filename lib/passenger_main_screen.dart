...
class _PassengerMainScreenState extends State<PassengerMainScreen> {
  ...
  void _startTrackingDriver() {
    ...
    DatabaseReference driverRef =
        FirebaseDatabase.instance.ref('drivers/$_assignedDriverId');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 20),
                          const Text("Thank you for choosing Flising.",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold),
      ...
      bottomNavigationBar: _rideStatus == 'IDLE' && !_showCompletionPopup
          ? BottomNavigationBar(
              backgroundColor: Colors.black,
