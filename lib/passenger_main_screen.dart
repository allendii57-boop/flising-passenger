...
class _PassengerMainScreenState extends State<PassengerMainScreen> {
  ...
  Future<void> _goToMyLocation() async {
    ...
    try {
      mapController.animateCamera(
          CameraUpdate.newLatLngZoom(const LatLng(-2.6741, 141.3028), 14.0));
    } catch (e) {}
    ...
    try {
      ...
      mapController
          .animateCamera(CameraUpdate.newLatLngZoom(_myLocation, 16.5));
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading:
                        Icon(Icons.location_on, color: flisingOrange),
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: flisingOrange.withOpacity(0.5))),
              child: ListTile(
                leading:
                    Icon(Icons.payments, color: flisingOrange, size: 30),
  ...
  void _findClosestDriver() async {
    ...
    if (driversSnap.exists) {
      final driversMap =
          driversSnap.value as Map<dynamic, dynamic>;
    ...
    if (closestDriverId == null) {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content:
              Text('No drivers online right now. Please try again.'),
    ...
    _ticketListener =
        db.ref('rides/$newRideId').onValue.listen((event) {
    ...
    Future.delayed(const Duration(seconds: 60), () {
      if (mounted && _rideStatus == 'SEARCHING') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content:
              Text('No response from driver. Please try again.'),
          backgroundColor: Colors.red,
  ...
  void _cancelRide() {
    ...
    if (_currentRideId != null) {
      FirebaseDatabase.instance.ref('rides/$_currentRideId').update(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_rideStatus == 'SEARCHING') ...[
                          ...
                          const SizedBox(height: 20),
                          const Text("Finding your premium ride...",
                              style:
